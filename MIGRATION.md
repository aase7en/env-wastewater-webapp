...
|---|---|---|---|
| SEC-DEPS-001 | GPT-5.6 Sol | 2026-08-29 | ACTIVE - frontend dependency/security remediation; owns package/lock, import-engine PDF scripting hardening + regression, bounded SSoT/claim/evidence only; no schema/RLS/carbon/Garden/PR49 workflow edits and no `.serena/**`. |
