...
|---|---|---|---|
| ENV-MOBILE-002 | GPT-5.6 Sol (GLM-5.3 limit fallback) | 2026-08-28 | ACTIVE / READY_FOR_IMPLEMENTATION — RED: both phone form groups x-delta 154px; delete targets ~19.125×24.797px; page containment + desktop density already pass. Owns `frontend/src/pages/ChemicalPage.tsx`, `frontend/tests/e2e/chemical-mobile.spec.ts`, work order/handoff/bounded status only. No `lib/chemical.ts`, schema/RLS, shared UI/AppShell, other forms, or Digital Twin edits. |
