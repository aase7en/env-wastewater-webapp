...
|---|---|---|---|
| ENV-MOBILE-004 | GPT-5.6 Sol | 2026-08-28 | ACTIVE / READY_FOR_IMPLEMENTATION — RED: phone form x-delta 154px; delete ~19.125×24.797px. History document containment + desktop density pass. Fuel page/test responsive lane only; GLM-5.3 MAX may run read-only Core audit. Data layer/import adapter/carbon view/schema/RLS/shared shell/other forms are no-touch. Contract: `docs/work-orders/ENV-MOBILE-004-FUEL.md`. |
