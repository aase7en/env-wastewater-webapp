...
|---|---|---|---|
| ENV-MOBILE-005 | GPT-5.6 Sol | 2026-08-28 | ACTIVE / IMPLEMENTING - owns only `frontend/src/pages/GardenPage.tsx`, `frontend/tests/e2e/garden-mobile.spec.ts`, Garden WO/handoff, this claim row, and bounded coordinator status. Garden data layer/schema/RLS/carbon/shared shell/Garbage/other forms and `.serena/` are read-only. |
