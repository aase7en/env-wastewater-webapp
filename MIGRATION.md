...
|---|---|---|---|
| ENV-MOBILE-003 | GPT-5.6 Sol (user-directed continuation) | 2026-08-28 | ACTIVE / READY_FOR_IMPLEMENTATION — RED: 360px form x-delta 154px; delete target ~19.125×24.797px. Document/table containment + desktop density already pass. Owns only `frontend/src/pages/WaterSupplyPage.tsx`, `frontend/tests/e2e/water-supply-mobile.spec.ts`, WO/handoff/bounded status. `frontend/src/lib/water-supply.ts`, schema/RLS, thresholds/compliance, shared UI/AppShell, other forms, and Digital Twin are read-only. |
