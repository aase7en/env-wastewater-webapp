...
**Active bounded slice:** `ENV-MOBILE-003` — Water Supply. Activated 2026-08-28 from exact `main@2e70c81b54dc20809c37dbe7a4d6a0e973172d11`; current gate is source-reality audit + phone-width RED/baseline before production mutation. Contract: `docs/work-orders/ENV-MOBILE-003-WATER-SUPPLY.md`.
