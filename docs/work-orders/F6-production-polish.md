...
- [2026-07-19] fable5 (F8): fonts dedupe — Jakarta ×5 + JetBrains ×2 เป็น variable font ไฟล์ MD5 เดียวกัน → ยุบเป็น @font-face weight-range เดียวต่อตระกูล + git rm 5 ไฟล์ซ้ำ (โหลดแรกเบาลง ~500KB); NAV pass เพิ่มทุก route เข้า sidebar (รายละเอียด: handoff review #5)
