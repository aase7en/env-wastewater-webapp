...
// SensorsPage (P20d.2) — lazy like the other recharts pages. Re-enabled
// 2026-07-31: the AppShell nav has linked /sensors since b948b10, so with the
// route commented out that menu item was a live 404.
